...
namespace GeneralSolutions.MVC.Controllers
{
    public class ItemsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Number,Color,Weight,IsAvailable,PurchaseDate,Price,Image,Guid,XML,Blob,FileName,TimeStamp,CategoryId,Model")] Item item)
        {
            if (ModelState.IsValid)
            {
